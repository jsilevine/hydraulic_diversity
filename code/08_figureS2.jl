##---------------------------------------------------------------
## Figure S2
## Variable annual rainfall, constant storm frequency
##---------------------------------------------------------------
...
##---------------------------------------------------------------
## Random annual precip, constant storm freq
##---------------------------------------------------------------
...
r_3 = generate_rainfall_regime(600, P, 15.0, mp, sd3, true, false)
length(r_3[1])
plot_rainfall_regime(r_3)
...
savefig("../figures/figureS2/figureS2.pdf")
