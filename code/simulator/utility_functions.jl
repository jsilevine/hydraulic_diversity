...
function generate_spp_data(Nspp::Int64, Wmax::Float64 = 0.8, n_ht::Int64 = 1, T::Float64 = 40.0,
    ...
    spp_data.τ = broadcast(calc_τ, spp_data.Aₘ, spp_data.r, spp_data.α, spp_data.δ, F, μ, T, b);
...
"""
function plot_simulation_dynamics(results, save::Bool = false, filename = "", cgrad = my_crad, lw = 3.5)
...
"""
function plot_canopy_cover(result, cgrad = my_cgrad, lw = 2.5, P = 10)
